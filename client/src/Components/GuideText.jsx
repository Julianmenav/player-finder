...
const GuideText = ({ callback }) => {
  ...
  return (
    <div className={`max-w-xs mt-8 shadow-md flex flex-col p-3 bg-gray-800 rounded-xl w-4/6 transition-opacity duration-1000 ${show ? "opacity-100" : "opacity-0"}`}>
      <p className="text-center text-sm font-bold text-white">
        Si no conoces ningún nombre, puedes probar con estos...
      </p>
